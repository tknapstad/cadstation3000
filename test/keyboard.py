#!/usr/bin/env python
""" Slightly modified version of the keyboard example from
...
def init_adapter(interface, device_name):
  ...
  subprocess.call(["hciconfig", interface, "class", "0x0025C0"])
...
def main():
  ...
  init_adapter(arguments.interface, "CAD Station 3000")
